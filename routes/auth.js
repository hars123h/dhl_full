...
const {
        ...
        getOtp,
        withdrawalSum, related_recharges, reset_withdrawal_password, commission, userdetailsUpdate, signinReward, task_reward, getcustomewithdrawl, deletePlan, promocode, teamrecharge, getFilteredWithdrawl, verifyOtp, requireSignin
...
router.post('/kdjbfekjfbekjfbekjfbewekjbwekfe', update_recharge);
...
router.get('/get_all_recharges', requireSignin, get_all_recharges);
router.get('/get_all_withdrawals', requireSignin, get_all_withdrawals);
router.post('/getcustomewithdrawl', getcustomewithdrawl);
...
router.get('/get_all_controllers', requireSignin, get_all_controllers);
...
router.post('/teamrecharge', teamrecharge);
router.post('/getFilteredWithdrawl', getFilteredWithdrawl);
