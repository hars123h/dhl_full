            ...
            <div className=" after:contents-[' '] after:fixed p-5">
                <div className="w-full mx-auto max-w-[800px]">
                    ...
                    <div>
                        ...
                        <a href='t.me/Lujosii' className="flex items-center border-black	border p-4 rounded-lg my-3 ">
                        ...
                        <a href='https://t.me/intelofficialchannel' className="flex items-center border-black	border p-4 rounded-lg my-3 ">
                            <img className="w-[45px] pr-[10px] border-r border-black" src={TeleImg} alt="" />
                            <div className="pl-[10px] pr-[10px] ">
                                <div className="text-black">Telegram</div>
                                <p className="text-[grey] text-[15px]">
